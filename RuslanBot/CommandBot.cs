...
namespace TankArena.TankBot
{
    public class CommandBot : IBot
    {
        ...
        {
            if (!Comandos.GetComandos().HasStartInfo)
                Comandos.GetComandos().SetStartInfo(startGameInfo);
            ...
            ID = Comandos.GetComandos().GetID();
            Comandos.GetComandos().Add(this);
        }
        ...
        public OutGameInfo ProcessMove(InGameInfo inGameInfo)
        {
            ...
            Comandos.GetComandos().HasStartInfo = false;
            return Comandos.GetComandos().GetMoveForBot(ID);
        }
    ...
    {
        SortedList<int, CommandBot> _comandosList;
        SortedList<int, Enemy> _enemies;
        static Comandos _Comandos;
        CommandBot _currentBot;
